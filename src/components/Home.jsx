    ...
    <div className=''>
        ...
        <motion.div initial={{opacity:0}}
         ...
         className='flex flex-col items-center text-center' >
            ...
            <h2 className=' text-2xl sm:text-3xl text-center pt-5'>Frontend Developer / React and Next js Developer</h2>
           

        </motion.div>
        <Link to="/contact" className='mt-5 w-36 sm:w-48 border-2 p-2 sm:p-5 text-sm text-center sm:text-2xl
        hover:-translate-y-1 hover:scale-110 hover:text-black hover:bg-white duration-300' >Let's Connect</Link>
        </div>
